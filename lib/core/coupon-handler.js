...
export function isPackageEligibleForOffer (packageItem, coupon) {
  ...
  const { minWeightInKg, maxWeightInKg, minDistanceInKm, maxDistanceInKm } = coupon
  return InRange(distanceInKm, minDistanceInKm, maxDistanceInKm) &&
        InRange(weightInKg, minWeightInKg, maxWeightInKg)
}
